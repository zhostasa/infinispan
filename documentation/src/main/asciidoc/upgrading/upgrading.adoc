...
== Upgrading from Infinispan 8.x to JBoss Data Grid 7.x
...
<<<<<<< HEAD:documentation/src/main/asciidoc/upgrading/upgrading.adoc
=======
...
>>>>>>> 3d4a1b3... ISPN-7446 Make the mode attribute on clustered caches optional and default to SYNC:documentation/src/main/asciidoc/upgrading/upgrading.asciidoc
