...
public final class TriangleFunctionsUtil {
   ...
   public static <K, V> WriteOnlyManyCommand<K, V> copy(WriteOnlyManyCommand<K, V> command, Collection<Object> keys) {
      ...
      copy.setKeys((Collection<? extends K>) keys);
      return copy;
   }
   ...
   public static Map<Object, Object> mergeHashMap(Map<Address, Response> responses, Map<Object, Object> resultMap) {
   ...
   public static Void voidMerge(Map<Address, Response> ignored1, Void ignored2) {
      return null;
   }

   public static List<Object> mergeList(Map<Address, Response> responses, List<Object> resultList) {
      ValidResponse response = (ValidResponse) responses.values().iterator().next();
      //noinspection unchecked
