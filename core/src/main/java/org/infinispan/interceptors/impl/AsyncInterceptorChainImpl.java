...
public class AsyncInterceptorChainImpl implements AsyncInterceptorChain {
   ...
   private static final Map<Class<? extends CommandInterceptor>, Class<? extends AsyncInterceptor>> legacyInterceptors;
   ...
   private boolean interceptorMatches(AsyncInterceptor interceptor,
      ...
      Class<? extends AsyncInterceptor> realClazz = legacyInterceptors.getOrDefault(clazz, clazz);
