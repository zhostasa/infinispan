...
public class MetaParamsTest {
   ...
   public void testDuplicateParametersOnConstruction() {
      MetaEntryVersion<Long> versionParam1 = new MetaEntryVersion<>(new NumericVersion(100));
      MetaEntryVersion<Long> versionParam2 = new MetaEntryVersion<>(new NumericVersion(200));
   ...
   public void testDuplicateParametersOnAdd() {
      ...
      MetaEntryVersion<Long> versionParam3 = new MetaEntryVersion<>(new NumericVersion(300));
      MetaEntryVersion<Long> versionParam4 = new MetaEntryVersion<>(new NumericVersion(400));
