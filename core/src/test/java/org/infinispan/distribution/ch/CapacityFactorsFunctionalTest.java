...
public class CapacityFactorsFunctionalTest extends MultipleCacheManagersTest {
   ...
   public void testCapacityFactors() {
      ...
      CapacityFactor.capacityFactor(cb.clustering().hash(), 0.5f);
      ...
      CapacityFactor.capacityFactor(cb.clustering().hash(), 1.5f);
      addClusterEnabledCacheManager(cb);
      waitForClusterToForm();
      ...
      CapacityFactor.capacityFactor(cb.clustering().hash(), 0.0f);
      addClusterEnabledCacheManager(cb);
      waitForClusterToForm();
      ...
      CapacityFactor.capacityFactor(cb.clustering().hash(), 1.0f);
      addClusterEnabledCacheManager(cb);
      waitForClusterToForm();
